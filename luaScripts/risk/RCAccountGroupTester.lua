...
function init()
    ...
    m_strLogTagOriginal = "[ accoutgroup_test : group=" .. tostring(m_nGroupId) ..  " ] "
...
function check(param)
    ...
    local vecRes = rcTestAccountGroupReverse(param.m_cmd.m_stockParams, m_nGroupId)
